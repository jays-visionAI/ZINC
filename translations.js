...
const translations = {
    en: {
        ...
        'studio.label.chatHistory': 'Chat History',
        'studio.label.contextHistory': 'Context History',
        'studio.label.newSession': 'New',
        'studio.log.maxAttachments': '[WARNING] Max {{count}} attachments allowed.',
        ...
        'studio.log.messageQueued': 'AI is busy. Message added to queue...',
        'studio.log.thinking': 'Thinking...',
        'studio.log.thinkingProcess': 'Thinking Process',
        'studio.log.thinkingAnalyzing': 'Analyzing request...',
        'studio.log.thinkingCore': 'Loading context...',
        'studio.log.thinkingBrain': 'Recall memory...',
        'studio.log.thinkingKnowledge': 'Checking assets...',
        'studio.log.thinkingMarket': 'Scanning trends...',
        'studio.log.thinkingGap': 'Synthesizing...',
        'studio.log.generatingResponse': 'Generating response...',
    ...
    ko: {
        ...
        'studio.label.chatHistory': '대화 기록',
        'studio.label.contextHistory': '맥락 기록',
        'studio.label.newSession': '새 대화',
        'studio.sourceContext.untitledPlan': 'Untitled Plan',
        'studio.log.maxAttachments': '[WARNING] 최대 {{count}}개까지 첨부 가능합니다.',
        ...
        'studio.log.messageQueued': 'AI가 생각 중입니다. 메시지가 대기열에 추가되었습니다.',
        'studio.log.thinking': '생각 중...',
        'studio.log.thinkingProcess': '생각 과정 (Thinking Process)',
        'studio.log.thinkingAnalyzing': '요청을 분석하고 있습니다...',
        'studio.log.thinkingCore': '컨텍스트 로딩 중...',
        'studio.log.thinkingBrain': '기억을 되짚는 중...',
        'studio.log.thinkingKnowledge': '관련 자료 확인 중...',
        'studio.log.thinkingMarket': '필요한 정보 탐색 중...',
        'studio.log.thinkingGap': '답변 구성 중...',
        'studio.log.generatingResponse': '응답 생성 중...',
