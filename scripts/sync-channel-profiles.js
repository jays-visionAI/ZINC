...
(async function syncChannelProfiles() {
    ...
    const targetChannels = [
        ...
        },
        {
            ...
            key: "naver_searchad",
            name: "Naver SearchAD",
            displayName: "Naver SearchAD",
            icon: "N",
            order: 16,
            supportsApiConnection: false,
            status: "active",
            category: "marketing",
            contentTypes: ["ad"],
            interactionStyle: { tone: "Strategic" },
            apiCredentialConfig: { fields: [] },
            version: "1.0.0"
        },
        {
            id: "naver_map",
            ...
            status: "active",
            category: "location",
            contentTypes: ["location", "review"],
            interactionStyle: { tone: "Informative" },
            apiCredentialConfig: { fields: [] },
            version: "1.0.0"
        },
        {
        ...
        },
        {
            ...
            interactionStyle: { tone: "Commercial" },
            apiCredentialConfig: { fields: [] },
            version: "1.0.0"
        },
        {
        ...
        },
        {
            ...
            category: "food",
            contentTypes: ["food"],
            interactionStyle: { tone: "Friendly" },
            apiCredentialConfig: { fields: [] },
            version: "1.0.0"
        },
        {
            ...
            category: "food",
            contentTypes: ["food"],
            interactionStyle: { tone: "Energetic" },
            apiCredentialConfig: { fields: [] },
            version: "1.0.0"
        }
    ];
