        ...
        case 'x':
            return `
                <div class="preview-x-post">
                    <div class="x-header">
                        <div class="x-avatar">
                            <img src="https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(state.projectName || 'Brand')}&backgroundColor=1d9bf0" alt="avatar" style="width:100%;height:100%;border-radius:50%;">
                        </div>
                        <div class="x-user-info">
                            ...
                            <span class="x-handle">@${(state.projectName || 'brand').toLowerCase().replace(/\s/g, '')} · 방금</span>
                        </div>
