                ...
                <div class="mb-5">
                    <div class="flex items-baseline gap-2">
                        <div class="text-2xl font-bold text-white tracking-tight">
                            ${(typeof trend.mentions === 'number') ? trend.mentions : (trend.evidence ? trend.evidence.length : trend.volume)}
                        </div>
                        <span class="text-[10px] text-slate-500 uppercase tracking-wider font-semibold">
                            ${(typeof trend.mentions === 'number' || trend.evidence) ? 'Mentions' : 'Volume'}
                        </span>
                    </div>
                </div>
